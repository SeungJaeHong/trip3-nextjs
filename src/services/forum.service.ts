...
export const toggleCommentEnabled = async (content: ForumPostType, value: boolean): Promise<AxiosResponse> => {
    return await ApiClient.post('/forum/' + content.id + '/comments_enabled', {
        value: value,
    })
}
